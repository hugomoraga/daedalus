...
import type { ExpectedValue } from "../../domain/proposal-generation/value-objects.ts";
import { appendIntents, enrich } from "../shared/lineage.ts";
import { finalizeDraft } from "../../domain/proposal-generation/proposal-draft.ts";
import { ProposalGenerated } from "../../domain/core/value-chain.ts";
